...
# Simulation time
DAYS = 240 # DUR1_MAX + DUR2_MAX + DUR3 < DAYS
...
BETA1_MAX   = 0.3   * 10
BETA1_START = 0.098 * 10
BETA1_STEP  = 0.01

BETA2_MAX   = 0.3   * 10
BETA2_START = 0.137 * 10
BETA2_STEP  = 0.01

BETA3_MAX   = 0.3   * 10
BETA3_START = 0.068 * 10
BETA3_STEP  = 0.01
...
DUR1_LABEL    = 'Controlled expansion duration'
DUR2_LABEL    = 'Xmas duration (including transition)'
TRA1_LABEL    = 'Transition to Xmas duration'
TRA2_LABEL    = 'Transition to confinement duration'
BETA1_LABEL   = 'Beta during controlled expansion (x10)'
BETA2_LABEL   = 'Beta during Xmas (x10)'
BETA3_LABEL   = 'Beta during confinement (x10)'
DRATE_LABEL   = 'Death rate (%)'

TEXT_INTRO    = 'Use the mouse for initial selection and cursors for fine tuning:'
TEXT_SUMMARY  = 'Stats:'
TEXT_NOTES    ='<b>Notes:</b><br/>\
              &bull; Xmas phase is highlighted in red.<br/>\
              &bull; Adjacent highlights represent transition periods.<br/>\
              &bull; Pre/post Xmas phases appear in white.<br/>\
